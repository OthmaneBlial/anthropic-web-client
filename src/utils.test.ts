import { getStoredValue, setStoredValue, createMessageElement, prepareMessages } from './utils';
...
describe('utils', () => {
  describe('getStoredValue', () => {
    ...
    it('should return the default value if the stored value does not exist', () => {
      expect(getStoredValue('nonExistentKey', 'defaultValue')).toBe('defaultValue');
    });
  });
